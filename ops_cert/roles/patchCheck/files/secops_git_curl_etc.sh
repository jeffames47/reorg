...
### hangs ?   yum remove java-1.7.0-openjdk-headless-1.7.0.261-2.6.22.2.el7_8.x86_64
###  this one hangs yum remove java-1.7.0-openjdk-1.7.0.101-2.6.6.1.el7_2.x86_64

### these hangs yum remove java-1.7.0-openjdk-devel-1.7.0.101-2.6.6.1.el7_2.x86_64
