...
# Last modified:  Tue Mar 28 15:06:11 EST 2023
...
rm -f /opt/splunkforwarder-9.0.1-82c987350fde-Linux-x86_64.tgz
rm -f /tmp/splunkforwarder-9.0.1-82c987350fde-Linux-x86_64.tgz
