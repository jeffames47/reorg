...
#
cd /tmp
#yes | scp -r 10.10.120.200:/home/james/op/roles/patchCheck/files/LINUX/* .
#hst=`hostname`
...
./ctagent_e_setup_linux_x64_04002000_17139_20200728.run --mode unattended --prefix /opt/Cimcor/CimTrak --agentname `hostname` --repository PRBNAWFIM01.navihealth.local --port 3749 --user cimtrak_installer --password '!nstall2020'
